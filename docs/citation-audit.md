...
The site applies two codebooks at runtime:

1. **Moore et al. 2026** (28 codes), CC-BY-SA 4.0, quoted verbatim from Appendix B.1 with attribution.
2. **ismyaialive supplemental** (7 codes prefixed `iaa-`), MIT-licensed (this repo), catalogued by the operator from publicly documented cases (Brooks/NYT 2025-08-08, Lemoine/Medium 2022) before Moore was published. Spec at `docs/patterns.md`. No measured inter-annotator agreement; confidence capped at "medium" in production.
