...
const inUncached = (usage.input_tokens || 0) - (usage.cache_read_input_tokens || 0) - (usage.cache_creation_input_tokens || 0);
const cost = (
  (usage.cache_creation?.ephemeral_1h_input_tokens || 0) / 1_000_000 * 1.6 +
  (usage.cache_creation?.ephemeral_5m_input_tokens || 0) / 1_000_000 * 1.0 +
  (usage.cache_read_input_tokens || 0) / 1_000_000 * 0.08 +
  Math.max(0, inUncached) / 1_000_000 * 0.80 +
